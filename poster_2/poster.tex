...
\bibitem{hello} 
A numerical algorithm for $L_{2}$ semi-discrete optimal transport in 3D, Bruno Levy et al, 2014
\bibitem{vffd}
 Volume Preserving FFD for Programmable Graphics Hardware.  Hanmann, G et al., 2012.
\bibitem{cffd}
Generative Models for the Deformation of Industrial Shapes with Linear Geometric Constraints: model order and parameter space reductions. Padula, G et al., 2023.a
\end{thebibliography}
\endgroup
\end{posterbox}
