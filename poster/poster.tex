...
\headerbox{Generative Models}{name=introduction,below=auto,column=0,row=0,span=3}{
\hspace{.2cm}
...
\headerbox{Optimal transport}{name=introduction,aligned=introduction,column=3,row=0,span=3}{
\hspace{.2cm}
