...
\begin{center}
\includegraphics[scale=0.068]{0} \\
\includegraphics[scale=0.068]{100}\\
\includegraphics[scale=0.068]{200}\\
\end{center}
\end{minipage}
\end{posterbox}
...
\item Generative adversarial networks: it is characterized by a generator that samples point cloud mesh of deformed Bulbous bow and by a discriminator that accepts real Bulbous (figure b)) and rejects deformed ones (figure a)).  \\
a)\begin{tikzpicture}[thick,scale=0.7, every node/.style={scale=0.7},
