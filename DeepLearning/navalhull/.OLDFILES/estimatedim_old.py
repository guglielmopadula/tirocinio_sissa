...
alls=alls.reshape(alls.shape[0],-1)
dims=np.zeros(100)

for i in range(0,100):
    print(i)
    dims[i]=skdim.id.TwoNN().fit(alls[:np.max([(i*500+1),3])]).dimension_
  
plt.plot(500*np.arange(100),dims)
