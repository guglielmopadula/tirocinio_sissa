...
\includegraphics[width=.47\textwidth,keepaspectratio]{Area_hist_AE}\hfill%
\includegraphics[width=.47\textwidth,keepaspectratio]{Area_hist_VAE}\\[0.001pt]
\includegraphics[width=.47\textwidth,keepaspectratio]{Area_hist_AAE}\hfill%
\includegraphics[width=.47\textwidth,keepaspectratio]{Area_hist_BEGAN}
\end{minipage}
}
\end{frame}
\begin{frame}{Total Curvature}
\makebox[\textwidth]{%
\begin{minipage}{1.00\textwidth} % <--- can be as large the slide size permits
\includegraphics[width=.47\textwidth,keepaspectratio]{TC_hist_AE}\hfill%
\includegraphics[width=.47\textwidth,keepaspectratio]{TC_hist_VAE}\\[0.001pt]
\includegraphics[width=.47\textwidth,keepaspectratio]{TC_hist_AAE}\hfill%
\includegraphics[width=.47\textwidth,keepaspectratio]{TC_hist_BEGAN}
\end{minipage}
}
\end{frame}
