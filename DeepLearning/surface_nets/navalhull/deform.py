...
for i in range(300,500):
    ...
    ffd.reset_weights()
    ffd.array_mu_x[2, 2, 1] += param[0]
    ffd.array_mu_x[2, 2, 0] += param[1]
    ffd.array_mu_x[2, 1, 1] += param[2]
    ffd.array_mu_x[2, 1, 0] += param[3]
    ffd.array_mu_x[2, 0, 1] += param[4]
    ffd.array_mu_z[1, 2, 1] += param[5]
    ffd.array_mu_z[2, 1, 2] += param[6]
    ffd.array_mu_x[2, 4, 2] += param[7]
    ffd.array_mu_x[2, 5, 2] += param[8]
    ffd.array_mu_x[2, 4, 3] += param[9]
    ffd.array_mu_x[2, 5, 3] += param[10]
    ffd.array_mu_x[2, 4, 0] += param[11]
    ffd.array_mu_x[2, 4, 1] += param[12]
    ffd.array_mu_x[2, 5, 0] += param[13]
    ffd.array_mu_x[2, 5, 1] += param[14]
    ffd.array_mu_x[2, 2, 2] += param[15]
    ffd.array_mu_x[2, 3, 3] += param[16]
    ffd.array_mu_x[2, 2, 3] += param[17]
    ffd.array_mu_x[2, 3, 2] += param[18]
    ffd.array_mu_x[2, 2, 0] += param[19]
    ffd.array_mu_x[2, 2, 1] += param[20]
    ffd.array_mu_x[2, 3, 0] += param[21]
    ffd.array_mu_x[2, 3, 1] += param[22]
    ffd.array_mu_x[2, 0, 2] += param[23]
    ffd.array_mu_x[2, 1, 2] += param[24]
    ffd.array_mu_x[2, 0, 3] += param[25]
    ffd.array_mu_x[2, 1, 3] += param[26]
