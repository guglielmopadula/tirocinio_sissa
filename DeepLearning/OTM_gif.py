...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 11:34:14 2022
...
F_surf = extract_surface(F)


duration=2

fig_myv = mlab.figure(size=(1024, 1024), bgcolor=(1,1,1))
...
def make_frame(t):
    ...
    mlab.triangular_mesh(xyz[:,0],xyz[:,1],xyz[:,2],F_surf, figure=fig_myv)
    return mlab.screenshot(antialiased=True)

animation = mpy.VideoClip(make_frame, duration=duration)
animation.write_gif("sinc.gif", fps=100)